...
export default function FounderCard({ founder, index }) {
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -6 }}
      className="group relative overflow-hidden rounded-4xl border border-ink-200 bg-white p-6 shadow-sm transition-shadow hover:shadow-xl dark:border-ink-800 dark:bg-ink-900 sm:p-8"
    >
